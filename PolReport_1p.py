...
def main():
    ...
    bioprobe = int(input('\nBioprobe?\nC1-Urea [0], C1-Pyruvate [1], C2-Pyruvate [2], Fumarate [3], HP001 [4]. Alanine [5], KIC [6], C2-Pyruvate (deuterium) [7], Pyruvate (deuterium) [8]: '))
    ...
    root = tkinter.Tk()
    root.withdraw()
    hyperpol_dir = tkinter.filedialog.askdirectory(initialdir="Data/HP_1p")
